export const HtmlIcon = (props) => (
      <svg {...props} width="40" height="40" fill="none" viewBox="0 0 40 40" aria-hidden="true">
        <mask id="html_svg__b" width="32" height="40" x="4" y="0" maskUnits="userSpaceOnUse" style="mask-type:alpha">
        <path fill="url(#html_svg__a)" d="M4 4a4 4 0 0 1 4-4h16l12 12v24a4 4 0 0 1-4 4H8a4 4 0 0 1-4-4z"></path></mask>
